---
layout: post
title: How to setup a pipeline with GitHub Action in order to build and publish a Docker image from your repo into Docker Hub - Part 1
slug: github-actions-1
date_published: 2021-09-04T12:23:19.000Z
date_updated: 2021-10-18T18:34:45.000Z
tags: CI/CD, Github Actions, Continuos Integration, Continuous Deploy, Continuos Delivery
---

## CI/CD and how to setup a GitHub Action

## 1. Overview

Let's start this [series of posts](__GHOST_URL__/github-actions-pre) dedicated to GitHub Actions with the first article about the definition of Action and how to create our workflow using the actions made available by the community.
...
According to Wikipedia: **[Continuous Delivery (CD)](https://en.wikipedia.org/wiki/Continuous_delivery)** is anapproach in which teams produce software in short cycles, ensuring that the software can be reliably released at any time and, when releasing the software, without doing so manually
...
![](__GHOST_URL__/content/images/2021/09/Action-setup-2.png)
...
![](__GHOST_URL__/content/images/2021/09/Action-create-1.png)
...
![](__GHOST_URL__/content/images/2021/09/Action-create-greeting-1.png)

Choose Greeting Action example by Github
GitHub will create a **greetings.yml** file in the folder: "*.github/workflows*".
...
![](__GHOST_URL__/content/images/2021/09/Action-create-greeting2-1.png)
...
![](__GHOST_URL__/content/images/2021/09/issue-after-action.png)
